  ...
  return (
    <main>
      <div className="flex h-[80vh] items-center justify-center bg-orange-200 px-8 py-4 md:px-32 md:py-16">
        <div className="md:w-1/2">
          ...
          <div className="breadcrumbs text-sm">
            <ul>
              ...
              <li className="text-orange-600">10 Days Yoga Retreat</li>
            </ul>
          </div>
        ...
        >
          <Image
            src={require("../../public/yoga-retreat-10.png")}
            height={800}
            width={800}
            alt="image"
          />
      ...
      <div className="w-full items-center px-8 py-4 md:flex md:space-x-8 md:px-32 md:py-16">
        <div className="w-full md:w-1/2">
          ...
          <p className="text-justify">
            ...
            behind and focus on centering and grounding yourself. Our 10-day
        ...
        <div className="relative w-full md:w-1/2">
          <div className="w-full">
            <Image
              className="rounded"
              src="https://www.yogkulam.org/images/10-days-yoga-retreat.jpg"
              height={500}
              width={800}
              alt="aboutus "
            />
          ...
          <div className="w-full bg-orange-600 p-8 md:absolute md:top-[80%] md:left-[10%] md:h-[200px] md:w-[80%]">
            <h3 className="text-[20px] text-white  md:text-[30px]">
              10 Days Yoga Retreat At Rishikesh
            </h3>
            <p className="text-[#f1f1f1]">
              Come join us for our 10 day Yoga Retreat in Rishikesh to unfold
              the treasures that lie within. We promise to make it a memorable
      ...
      <div className="my-12 grid w-full grid-cols-1  md:h-[300px]  md:grid-cols-4">
        ...
        <div className="flex flex-col items-center justify-center bg-orange-600 p-4 ">
          ...
          <p className="text-lg text-white">USD 500</p>
        </div>
      </div>
      {/* pricing section */}
