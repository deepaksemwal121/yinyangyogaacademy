export const data = {
  ...
  guruProfile: [
    {
      image: "/../public/dheeru.jpg",
      name: "Yogacharya Dhirendra Bisht",
      expertise: "Ashtanga Vinayasa, Teaching Methodology",
      desc: "Born in the lap of the Holy Ganga, at the feet of the Bhootnath Shiva Temple, amidst the forests of ",
    },
    {
      image: "/../public/teacher1.jpg",
      name: "Amit Payal",
      expertise: "Hatha yoga, Alignment & adjustment",
      desc: "Amit Payal, the founder of Rishikesh Yogkulam, is an E-RYT 500-Hour Yoga instructor with a Master's ",
    },
    {
      image: "/../public/anant.jpg",
      name: "Anant Jethuri",
      expertise: "Yoga anatomy and physiology, Mantra chanting",
      desc: "Having pursued a masters in Biology followed by a 500 hour YTTC, Anant ji has always had a keen inte",
    },
    {
      image: "/../public/sonu.jpg",
